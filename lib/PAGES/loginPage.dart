...
import 'package:neostore_app/PAGES/HomePage.dart';
import 'package:neostore_app/PAGES/signUpPage.dart';
      ...
      child: FlatButton(
        onPressed: () async {
          if (_formKey.currentState.validate()) {
            ...
            try {
              var response =
                  await NeoStoreNetwork().getLoginResponse(loginRequestModel);
