                  ...
                  children: [
                    CircleAvatar(
                      backgroundImage: NetworkImage(
                          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKBxFgumtyI8kBb1RvhSfyqrqahJsu2XUScw&usqp=CAU'),
                      radius: 60.0,
                    ),
                    Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TablesListView(id: 1)));
                },
                child: ListTile(
                  leading: Image.asset(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TablesListView(id: 4)));
                },
                child: ListTile(
                  leading: Image.asset(
                    "images/cubIcon.png",
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TablesListView(id: 2)));
                },
                child: ListTile(
                  leading: Image.asset(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => TablesListView(id: 3)));
                },
                child: ListTile(
                  leading: Image.asset(
                    "images/sofaIcon.png",
